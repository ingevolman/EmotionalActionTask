 ...
 */
     typedef int *CPhidgetDictionaryHandle;
/**
 * A Dictionary key listener handle.
 */
     typedef int *CPhidgetDictionaryListenerHandle;
 ...
 */
     typedef int *CPhidgetManagerHandle;
...
__declspec (dllimport)
     int CPhidgetAccelerometer_set_OnAccelerationChange_Handler (CPhidgetAccelerometerHandle phid,
									   int (* fptr) (CPhidgetAccelerometerHandle phid, void *userPtr, int index, double acceleration), void *userPtr);
/**
 ...
 */
     ...
     typedef int *CPhidgetAdvancedServoHandle;
__declspec (dllimport)
...
__declspec (dllimport)
     int CPhidgetAdvancedServo_set_OnVelocityChange_Handler (CPhidgetAdvancedServoHandle phid,
								       int (* fptr) (CPhidgetAdvancedServoHandle phid, void *userPtr, int index, double velocity), void *userPtr);
...
__declspec (dllimport)
     int CPhidgetAdvancedServo_set_OnPositionChange_Handler (CPhidgetAdvancedServoHandle phid,
								       int (* fptr) (CPhidgetAdvancedServoHandle phid, void *userPtr, int index, double position), void *userPtr);
...
__declspec (dllimport)
     int CPhidgetAdvancedServo_set_OnCurrentChange_Handler (CPhidgetAdvancedServoHandle phid,
								      int (* fptr) (CPhidgetAdvancedServoHandle phid, void *userPtr, int index, double current), void *userPtr);
 ...
 */
     ...
     typedef int *CPhidgetAnalogHandle;
__declspec (dllimport)
 ...
 */
     ...
     typedef int *CPhidgetBridgeHandle;
__declspec (dllimport)
 ...
 */
     ...
     typedef int *CPhidgetEncoderHandle;
__declspec (dllimport)
...
__declspec (dllimport)
     int CPhidgetEncoder_set_OnPositionChange_Handler (CPhidgetEncoderHandle phid,
								 int (* fptr) (CPhidgetEncoderHandle phid, void *userPtr, int index, int time, int positionChange), void *userPtr);
/**
 ...
 */
     ...
     typedef int *CPhidgetFrequencyCounterHandle;
__declspec (dllimport)
...
__declspec (dllimport)
     int CPhidgetFrequencyCounter_set_OnCount_Handler (CPhidgetFrequencyCounterHandle phid,
								 int (* fptr) (CPhidgetFrequencyCounterHandle phid, void *userPtr, int index, int time, int counts), void *userPtr);
 ...
 */
__declspec (dllimport)
     int CPhidgetGPS_set_OnPositionChange_Handler (CPhidgetGPSHandle phid, int (* fptr) (CPhidgetGPSHandle phid, void *userPtr, double latitude, double longitude, double altitude),
							     void *userPtr);
/**
 ...
 */
     ...
     typedef int *CPhidgetInterfaceKitHandle;
__declspec (dllimport)
...
__declspec (dllimport)
     int CPhidgetInterfaceKit_set_OnOutputChange_Handler (CPhidgetInterfaceKitHandle phid,
								    int (* fptr) (CPhidgetInterfaceKitHandle phid, void *userPtr, int index, int outputState), void *userPtr);
...
__declspec (dllimport)
     int CPhidgetInterfaceKit_set_OnSensorChange_Handler (CPhidgetInterfaceKitHandle phid,
								    int (* fptr) (CPhidgetInterfaceKitHandle phid, void *userPtr, int index, int sensorValue), void *userPtr);
/**
 ...
 */
__declspec (dllimport)
     int CPhidgetIR_set_OnCode_Handler (CPhidgetIRHandle phid, int (* fptr) (CPhidgetIRHandle phid, void *userPtr, unsigned char *data, int dataLength, int bitCount, int repeat),
						  void *userPtr);
/**
...
__declspec (dllimport)
     int CPhidgetIR_set_OnLearn_Handler (CPhidgetIRHandle phid,
						   int (* fptr) (CPhidgetIRHandle phid, void *userPtr, unsigned char *data, int dataLength, CPhidgetIR_CodeInfoHandle codeInfo),
						   void *userPtr);
/**
 ...
 */
     ...
     typedef int *CPhidgetMotorControlHandle;
__declspec (dllimport)
...
__declspec (dllimport)
     int CPhidgetMotorControl_set_OnVelocityChange_Handler (CPhidgetMotorControlHandle phid,
								      int (* fptr) (CPhidgetMotorControlHandle phid, void *userPtr, int index, double velocity), void *userPtr);
...
__declspec (dllimport)
     int CPhidgetMotorControl_set_OnCurrentChange_Handler (CPhidgetMotorControlHandle phid,
								     int (* fptr) (CPhidgetMotorControlHandle phid, void *userPtr, int index, double current), void *userPtr);
 ...
 */
__declspec (dllimport)
     int CPhidgetMotorControl_set_OnInputChange_Handler (CPhidgetMotorControlHandle phid, int (* fptr) (CPhidgetMotorControlHandle phid, void *userPtr, int index, int inputState),
								   void *userPtr);
...
__declspec (dllimport)
     int CPhidgetMotorControl_set_OnEncoderPositionChange_Handler (CPhidgetMotorControlHandle phid,
									     int (* fptr) (CPhidgetMotorControlHandle phid, void *userPtr, int index, int time, int positionChange),
									     void *userPtr);
/**
...
__declspec (dllimport)
     int CPhidgetMotorControl_set_OnEncoderPositionUpdate_Handler (CPhidgetMotorControlHandle phid,
									     int (* fptr) (CPhidgetMotorControlHandle phid, void *userPtr, int index, int positionChange), void *userPtr);
...
__declspec (dllimport)
     int CPhidgetMotorControl_set_OnBackEMFUpdate_Handler (CPhidgetMotorControlHandle phid,
								     int (* fptr) (CPhidgetMotorControlHandle phid, void *userPtr, int index, double voltage), void *userPtr);
...
__declspec (dllimport)
     int CPhidgetMotorControl_set_OnSensorUpdate_Handler (CPhidgetMotorControlHandle phid,
								    int (* fptr) (CPhidgetMotorControlHandle phid, void *userPtr, int index, int sensorValue), void *userPtr);
/**
 ...
 */
     ...
     typedef int *CPhidgetPHSensorHandle;
__declspec (dllimport)
 ...
 */
     ...
     typedef int *CPhidgetRFIDHandle;
__declspec (dllimport)
 ...
 */
__declspec (dllimport)
     int CPhidgetRFID_set_OnTag2_Handler (CPhidgetRFIDHandle phid, int (* fptr) (CPhidgetRFIDHandle phid, void *userPtr, char *tagString, CPhidgetRFID_Protocol protocol),
						    void *userPtr);
/**
 ...
 */
__declspec (dllimport)
     int CPhidgetRFID_set_OnTagLost2_Handler (CPhidgetRFIDHandle phid, int (* fptr) (CPhidgetRFIDHandle phid, void *userPtr, char *tagString, CPhidgetRFID_Protocol protocol),
							void *userPtr);
 ...
 */
     ...
     typedef int *CPhidgetServoHandle;
__declspec (dllimport)
 ...
 */
     ...
     typedef int *CPhidgetSpatialHandle;
__declspec (dllimport)
 ...
 */
__declspec (dllimport)
     int CPhidgetSpatial_setCompassCorrectionParameters (CPhidgetSpatialHandle phid, double magField, double offset0, double offset1, double offset2, double gain0, double gain1,
...
__declspec (dllimport)
     int CPhidgetSpatial_set_OnSpatialData_Handler (CPhidgetSpatialHandle phid,
							      int (* fptr) (CPhidgetSpatialHandle phid, void *userPtr, CPhidgetSpatial_SpatialEventDataHandle * data, int dataCount),
							      void *userPtr);
 ...
 */
     ...
     typedef int *CPhidgetStepperHandle;
__declspec (dllimport)
 ...
 */
__declspec (dllimport)
     int CPhidgetStepper_set_OnVelocityChange_Handler (CPhidgetStepperHandle phid, int (* fptr) (CPhidgetStepperHandle phid, void *userPtr, int index, double velocity),
								 void *userPtr);
 ...
 */
__declspec (dllimport)
     int CPhidgetStepper_set_OnPositionChange_Handler (CPhidgetStepperHandle phid, int (* fptr) (CPhidgetStepperHandle phid, void *userPtr, int index, __int64 position),
								 void *userPtr);
 ...
 */
__declspec (dllimport)
     int CPhidgetStepper_set_OnCurrentChange_Handler (CPhidgetStepperHandle phid, int (* fptr) (CPhidgetStepperHandle phid, void *userPtr, int index, double current),
								void *userPtr);
 ...
 */
     ...
     typedef int *CPhidgetTemperatureSensorHandle;
__declspec (dllimport)
...
__declspec (dllimport)
     int CPhidgetTemperatureSensor_set_OnTemperatureChange_Handler (CPhidgetTemperatureSensorHandle phid,
									      int (* fptr) (CPhidgetTemperatureSensorHandle phid, void *userPtr, int index, double temperature),
									      void *userPtr);
/**
 ...
 */
     ...
     typedef int *CPhidgetTextLCDHandle;
__declspec (dllimport)
 ...
 */
     ...
     typedef int *CPhidgetTextLEDHandle;
__declspec (dllimport)
 ...
 */
     ...
     typedef int *CPhidgetWeightSensorHandle;
__declspec (dllimport)
 ...
 */
__declspec (dllimport)
     int CPhidgetWeightSensor_set_OnWeightChange_Handler (CPhidgetWeightSensorHandle phid, int (* fptr) (CPhidgetWeightSensorHandle phid, void *userPtr, double weight),
								    void *userPtr);
/**
