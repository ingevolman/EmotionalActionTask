...
%if ~strcmp(cfg.cmp,'WindowsXP') %if not windows XP
    ...
    if strcmp(cfg.cmp,'WindowsXP'),   Screen('Preference', 'DefaultFontSize', 20);
    else, Screen('Preference', 'DefaultFontSize', 30);
    end
    %oldResolution = Screen('Resolution',0,1280,1024,75);
    %oldResolution = Screen('Resolution',0,2880,1800,60);
    %oldResolution = Screen('Resolution',0,2048,1152,60);
  % oldResolution = Screen('Resolution',0,1920,1080,75);
    %oldResolution = Screen('Resolution',0,1280,720,60);
     oldResolution = Screen('Resolution',0,1680,1050,60);
